#!/bin/bash
#SBATCH --job-name=hisat2_mapping_v2
#SBATCH --output=/mnt/scratch2/users/40500972/mapping/hisat2_mapping_v2.log
#SBATCH --error=/mnt/scratch2/users/40500972/mapping/hisat2_mapping_v2.err
#SBATCH --ntasks=1
...
echo "=== HISAT2 mapping v2 started: $(date) ==="
